...
pub async fn login<L, R, V, S, C, O, REX, TEX, I>(
...
pub async fn refresh<L, R, V, S, C, O, REX, TEX, I>(
    State(state): State<AppState<L, R, V, S, C, O, REX, TEX, I>>,
...
pub async fn verify<L, R, V, S, C, O, REX, TEX, I>(
    State(state): State<AppState<L, R, V, S, C, O, REX, TEX, I>>,
...
pub async fn logout<L, R, V, S, C, O, REX, TEX, I>(
    State(state): State<AppState<L, R, V, S, C, O, REX, TEX, I>>,
